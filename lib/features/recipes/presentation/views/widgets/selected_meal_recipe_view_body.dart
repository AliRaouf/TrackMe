...
import 'package:track_me_updated/features/recipes/presentation/views/widgets/selected_recipe_view_body_shimmer.dart';
        ...
        builder: (context, state) {
          if (state is SearchRecipeIdError) {
            ...
            return Scaffold(
                ...
                body:
                    // SelectedRecipeViewBody(recipeModel: state.recipe),
                    const SelectedRecipeViewBodyShimmer());
          }
        },
      ),
    );
